    ...
    SecondAppTheme {
        ...
        Column(modifier = Modifier
            ...
            Row(
                ...
                Text(
                    "Monitor heart rate and get notified", modifier = Modifier
...
fun InfoPage(click: () -> Unit) {
    Column(
        ...
        Row() {
            Text(
                text = "What is normal Heart rate?",
...
fun DangerScreen(click: () -> Unit){
    ...
    Column(
        ...
        Row( ){
                Text(text = "Don't fret Heart anamoly diagnosed", fontSize = 8.sp, color = Color.White, modifier = Modifier.padding(start=7.dp, end = 7.dp))
        }
        Row( modifier = Modifier.padding(top=15.dp)){
            Button(onClick = {  click() }, colors= ButtonDefaults.buttonColors(backgroundColor = Color.White),modifier = Modifier
                .height(20.dp)
